...
class WarnetSelectionPSPage extends StatelessWidget {
  Future<List<Map<String, dynamic>>> fetchWarnetData() async {
    try {
      final response =
          await http.get(Uri.parse('http://10.0.2.2:8000/api/warnets'));
      if (response.statusCode == 200) {
        ...
        return data
            .map((item) => {
                  ...
                  "rating":
                      item['stars'] != null ? double.parse(item['stars']) : 0.0,
      ...
      print('Error fetching warnet data: $e');
                                        ...
                                        Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              SizedBox(height: 8.0),
                                              Text(
                                                'Available PlayStations: ${warnet['availablePs']}',
                                                style: theme
                                                    .textTheme.bodyMedium
                                                    ?.copyWith(
                                                  fontFamily: 'Poppins',
